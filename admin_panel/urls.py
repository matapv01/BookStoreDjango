...
urlpatterns = [
    ...
    path('users/<int:pk>/edit/', views.user_edit, name='user_edit'), # Add this line
    path('users/<int:pk>/toggle-status/', views.toggle_user_status, name='toggle_user_status'),
    # path('users/<int:pk>/delete/', views.user_delete, name='user_delete'), # Add this later if needed
