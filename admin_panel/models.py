...
class SystemSettings(models.Model):
    ...
    # System settings
    maintenance_mode = models.BooleanField(default=False, help_text="Khi bật chế độ bảo trì, website sẽ hiển thị trang bảo trì cho người dùng thông thường")
    is_active = models.BooleanField(default=True, help_text="Khi tắt, website sẽ tự động chuyển sang chế độ bảo trì")
